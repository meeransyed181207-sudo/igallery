...
<body>
    ...
    <div class="main-content">
        <div class="gallery-container">
            <img id="galleryImage" class="gallery-image" src="avngers.jpg">
            <div id="caption" class="caption">AVENGERS ENDGAME POSTER</div>
    ...
    <div class="footer-banner">
       Desinged by SYED MEERAN A(25008812) &copy;
    </div>
